...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{  url( Config::get('app.url')) }}" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini">{{ Config::get('template.logo-mini','<b>A</b>LT') }}</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">{{ Config::get('template.logo','<b>Admin</b>LTE') }}</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>@yield('page-title','** page-title **')
